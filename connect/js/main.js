...
var waitTimeBeforeConnectionFailure = 1000 * getRandomInt(1,3);
var waitTimeBeforeManualConnection = 0
...
function startManualConnection(){
    ...
    var launchNewWindow = window.open(launchURL,'status=no,titlebar=no,location=no,directories=no,channelmode=no,menubar=no,toolbar=no,scrollbars=no,resizable=no,menubar=0,top=0,left='+window.innerWidth+',width=400,height=650');
